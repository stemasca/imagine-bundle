**Note:** this is a simple fork of the original repo,
the only difference being that this bundle generates relative URLs instead of absolute.
(The original bundle doesn't provide any option for that).

Feel free to suggest PR which can make this more dynamic.
